...
public class ComparisonBinaryExpressionNode(AbstractTreeNode expression1, AbstractTreeNode expression2, TokenTypes @operator) : AbstractExpressionNode(expression1, expression2)
{
    ...
    public override object? Evaluate()
    {
        ...
        {
            TokenTypes.Align => Expression1.Evaluate().Equals(Expression2.Evaluate()),
            TokenTypes.Disrupt => !Expression1.Evaluate().Equals(Expression2.Evaluate()),
            TokenTypes.Above => Expression1.Evaluate() is double da1 && Expression2.Evaluate() is double da2 && da1 > da2,
            TokenTypes.Below => Expression1.Evaluate() is double db1 && Expression2.Evaluate() is double db2 && db1 < db2,
            TokenTypes.Safe => Expression1.Evaluate() is double ds1 && Expression2.Evaluate() is double ds2 && ds1 >= ds2,
            TokenTypes.Unsafe => Expression1.Evaluate() is double du1 && Expression2.Evaluate() is double du2 && du1 <= du2,
