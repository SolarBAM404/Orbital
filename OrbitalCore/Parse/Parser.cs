...
using OrbitalCore.Parse.Nodes;
    ...
    public class Parser(List<Token> tokens)
    {
        ...
        public Dictionary<string, VariableNode> _globalVariables { get; }= new() ;
        ...
        private AbstractTreeNode ParsePrimary()
        {
            ...
            switch (current.TokenType)
            {
                ...
                case TokenTypes.Identifier:
                    ...
                    if (_globalVariables.TryGetValue(current.Value, out VariableNode? existingVariable))
                    {
                        return existingVariable;
                    }
                    VariableNode variableNode = new VariableNode(current.Value);
                    _globalVariables.Add(current.Value, variableNode);
